<template>
  <div id="app">
    ...
    <el-button size="small" style="float:right;margin-top:6px;margin-right:6px;" @click="modalVisible=true">查看流程图</el-button>
    ...
    <el-dialog title="查看流程图" :visible.sync="modalVisible" width="60%">
      <wfd-vue ref="wfd" :data="demoData1" :height="300" is-view />
    </el-dialog>
  </div>
</template>
